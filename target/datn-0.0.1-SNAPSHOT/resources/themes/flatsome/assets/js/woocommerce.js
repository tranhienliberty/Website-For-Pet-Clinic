!function(t) {
    ...
    64: function(t, e, i) {
        ...
        a.on("show_variation", (function(t, e) {
            ...
            n(),
            s(),
            c()) : (jQuery(".product-thumbnails .first img").attr("src", o),
            c())
        }
        )),
        a.on("hide_variation", (function(t, e) {
            jQuery(".product-thumbnails .first img, .sticky-add-to-cart-img").attr("src", o),
            c()
        }
        )),
    ...
    66: function(t, e) {
        Flatsome.plugin("addQty", (function(t, e) {
            jQuery(t).on("click", ".plus, .minus", (function() {
                ...
                t.is(".plus") ? r && (r === i || i > r) ? e.val(r) : e.val(i + parseFloat(a)) : o && (o === i || i < o) ? e.val(o) : i > 0 && e.val(i - parseFloat(a)),
                e.trigger("change")
            }
            ))
        }
