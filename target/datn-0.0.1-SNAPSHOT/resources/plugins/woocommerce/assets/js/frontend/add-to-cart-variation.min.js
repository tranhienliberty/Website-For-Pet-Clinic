!function(y, c, i, n) {
    ...
    t.prototype.onAddToCart = function(t) {
        ...
        y(this).is(".wc-variation-is-unavailable") ? c.alert(wc_add_to_cart_variation_params.i18n_unavailable_text) : y(this).is(".wc-variation-selection-needed") && c.alert(wc_add_to_cart_variation_params.i18n_make_a_selection_text))
    }
    ,
    ...
    t.prototype.onFoundVariation = function(t, a) {
        ...
        a.dimensions ? o.wc_set_content(y.parseHTML(a.dimensions_html)[0].data) : o.wc_reset_content(),
    ...
    t.prototype.onUpdateAttributes = function(t) {
        ...
        b.useAjax || (b.$attributeFields.each(function(t, a) {
            var i = y(a)
              ...
              , s = i.val() || ""
              , c = !0;
            i.data("attribute_html") || ((_ = i.clone()).find("option").removeAttr("attached").prop("disabled", !1).prop("selected", !1),
                    ...
                    for (l in v)
                        if (v.hasOwnProperty(l)) {
                            var g = v[l]
                              , u = "";
                            if (l === e)
                                if (m[d].variation_is_active && (u = "enabled"),
                                g) {
                                    g = y("<div/>").html(g).text();
                                    var f = n.find("option");
                                    if (f.length)
                                    ...
                                    n.find("option:gt(0)").addClass("attached " + u)
                        }
                }
            a = n.find("option.attached").length,
            s && (c = !1,
            0 !== a && n.find("option.attached.enabled").each(function() {
                var t = y(this).val();
                if (s === t)
                    return !(c = !0)
            })),
            0 < a && s && c && "no" === r && (n.find("option:first").remove(),
            o = ""),
