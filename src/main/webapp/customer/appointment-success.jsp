...
<h2 style="color: #00EE00;">Xin chào! Cảm ơn bạn ${appointment.name} đã lựa chọn dịch vụ của phòng khám chúng tôi!</h2>
<div style="text-align: center; margin-top: 20px;">
  <p style="font-size: 18px;"> Thông tin cuộc hẹn ở bên dưới! Đừng quên mã cuộc hẹn của bạn là : <span style="color: blue;">${token}</span>. Nhớ lưu lại nhé!</p>
  <a>
    <button style="background-color: rgb(255, 182, 193); color: white; padding: 10px 20px; border: none; border-radius: 5px; font-size: 16px; cursor: pointer;">Gửi email</button>
  </a>
    <a href="<%=request.getContextPath()%>/">
    <button style="background-color: rgb(255, 182, 193); color: white; padding: 10px 20px; border: none; border-radius: 5px; font-size: 16px; cursor: pointer;">Trở về trang chủ</button>
  </a>
</div>
	<main>
		<div class="container">
		  <ul class="responsive-table">
		    <li class="table-header" style="height: 70px;">
		      ...
		      <div class="col-md-1 text-center">Email</div>
		      <div class="col-md-3 text-center ">Ghi chú của khách</div>
		    ...
		    <li class="table-row" style="height: 70px;">
		      <div class="col-md-1 text-center" data-label="ID">${appointment.phone}</div>
		      <div class="col-md-1 text-center" data-label="ID">${appointment.email}</div>
		      <div class="col-md-1 text-center" data-label="ID">${appointment.note}</div>
		      <div class="col-md-3 text-center" data-label="Dịch vụ">${appointment.getService().getName_service()}</div>
		      <div class="col-md-4 text-center" data-label="Thời gian">${appointment.appointment_date}</div>
		    </li>
		  </ul>
		</div>
	</main>
